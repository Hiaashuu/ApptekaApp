...
import com.hiaashuu.appteka.screen.bdui.createBduiScreenActivityIntent
import com.hiaashuu.appteka.screen.create_chat.createCreateChatActivityIntent
...
import com.hiaashuu.appteka.screen.feed.createFeedFragment
...
import com.hiaashuu.appteka.screen.profile.createProfileFragment
...
import com.hiaashuu.appteka.screen.store.createStoreFragment
import com.hiaashuu.appteka.screen.topics.createTopicsFragment
...
class HomeActivity : AppCompatActivity(), HomePresenter.HomeRouter {
    ...
    override fun onCategoryMenuClicked() {
        val fragment = supportFragmentManager.findFragmentById(R.id.frame) as? StoreFragment
        fragment?.onCategoryMenuClicked()
    }
