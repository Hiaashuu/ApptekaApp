...
import com.hiaashuu.appteka.screen.uploads.adapter.ItemListener
...
interface UploadsPresenter : ItemListener {

    fun attachView(view: UploadsView)

    fun detachView()

    fun attachRouter(router: UploadsRouter)
...
class UploadsPresenterImpl(
    private val interactor: UploadsInteractor,
    ...
    private var view: UploadsView? = null
    private var router: UploadsPresenter.UploadsRouter? = null
    ...
    override fun attachView(view: UploadsView) {
        this.view = view
    ...
    override fun attachRouter(router: UploadsPresenter.UploadsRouter) {
        this.router = router
    }
