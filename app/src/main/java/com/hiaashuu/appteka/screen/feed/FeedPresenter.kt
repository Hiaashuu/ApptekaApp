...
class FeedPresenterImpl(
    ...
    override fun onReactionClick(item: FeedItem, reaction: com.hiaashuu.appteka.screen.feed.api.Reaction) {
        val items = items ?: return
    ...
    private fun onReactionResponse(postId: Long, reactions: Map<String, com.hiaashuu.appteka.screen.feed.api.Reaction>) {
        val items = items ?: return
    ...
    private fun onReactionError(
        postId: Long,
        reaction: com.hiaashuu.appteka.screen.feed.api.Reaction,
        wasActive: Boolean,
        previousCount: Int
    ) {
