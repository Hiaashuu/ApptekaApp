...
import com.hiaashuu.appteka.util.applyBottomInsets
import com.hiaashuu.appteka.util.applyBottomInsetsAsMargin
import com.hiaashuu.appteka.util.applyBottomMarginForView
import com.hiaashuu.appteka.util.applyTopInsets
...
interface HomeView {
    ...
    fun showCapabilityDenied(
        capability: com.hiaashuu.appteka.core.permissions.Capability,
    )
    ...
    fun categoryClicks(): Observable<Unit>
...
class HomeViewImpl(view: View) : HomeView {
    ...
    private val categoryRelay = PublishRelay.create<Unit>()
    ...
    init {
        toolbar.setOnMenuItemClickListener { item ->
            when (item.itemId) {
                ...
                R.id.menu_category -> categoryRelay.accept(Unit)
    ...
    override fun categoryClicks(): Observable<Unit> = categoryRelay
