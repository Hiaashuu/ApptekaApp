...
import com.hiaashuu.appteka.upload.UploadStatus
...
class UploadPresenterImpl(
    ...
    private fun onPrefillMetaLoaded(details: com.hiaashuu.appteka.screen.details.api.Details) {
